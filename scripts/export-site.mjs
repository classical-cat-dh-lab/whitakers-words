...
for (const file of ['index.html', 'app.mjs', 'input.mjs', 'worker.mjs', 'render-reader.mjs', 'offline.mjs', 'offline-core.mjs', 'style.css', 'validation-cases.json', 'icon.svg', 'manifest.webmanifest']) await add('browser/' + file);
